...
class TutorChatVC: UIViewController {
...
extension TutorChatVC: UITableViewDelegate, UITableViewDataSource {
...
extension TutorChatVC: UITextFieldDelegate {
